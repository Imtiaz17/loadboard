        ...
        <div class="shipper">
            ...
            <div class="columns">
                <div class="column">
                    <div class="field">
                        <div class="control">
                            <input class="input is-hovered" type="text" placeholder="Driver licence Id" v-model="form.driver_licence_id" name="Driver licence Id" v-validate="'required'" :class="{ 'is-danger': errors.has('Tax id') }">
                        </div>
                        <span v-show="errors.has('Driver licence Id')" class="invalid-feedback">{{ errors.first('Driver licence Id') }}</span>
                    </div>
                </div>
            </div>
            <div class="columns">
